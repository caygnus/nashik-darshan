...
type EventQuery struct {
	...
	withOverrides  *EventOverrideQuery
	withExceptions *EventExceptionQuery
...
func (_q *EventQuery) QueryPlace() *PlaceQuery {
...
func (_q *EventQuery) QueryOverrides() *EventOverrideQuery {
	query := (&EventOverrideClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *EventQuery) QueryExceptions() *EventExceptionQuery {
	query := (&EventExceptionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *EventQuery) Clone() *EventQuery {
	...
	return &EventQuery{
		...
		withExceptions: _q.withExceptions.Clone(),
...
func (_q *EventQuery) WithPlace(opts ...func(*PlaceQuery)) *EventQuery {
	query := (&PlaceClient{config: _q.config}).Query()
...
func (_q *EventQuery) WithOverrides(opts ...func(*EventOverrideQuery)) *EventQuery {
	query := (&EventOverrideClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) WithExceptions(opts ...func(*EventExceptionQuery)) *EventQuery {
	query := (&EventExceptionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withExceptions = query
	return _q
}
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withPlace; query != nil {
		if err := _q.loadPlace(ctx, query, nodes, nil,
			func(n *Event, e *Place) { n.Edges.Place = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOverrides; query != nil {
		if err := _q.loadOverrides(ctx, query, nodes,
			func(n *Event) { n.Edges.Overrides = []*EventOverride{} },
			func(n *Event, e *EventOverride) { n.Edges.Overrides = append(n.Edges.Overrides, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withExceptions; query != nil {
		if err := _q.loadExceptions(ctx, query, nodes,
			func(n *Event) { n.Edges.Exceptions = []*EventException{} },
			func(n *Event, e *EventException) { n.Edges.Exceptions = append(n.Edges.Exceptions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventQuery) loadPlace(ctx context.Context, query *PlaceQuery, nodes []*Event, init func(*Event), assign func(*Event, *Place)) error {
...
func (_q *EventQuery) loadOverrides(ctx context.Context, query *EventOverrideQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventOverride)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(eventoverride.FieldEventID)
	}
	query.Where(predicate.EventOverride(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.OverridesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) loadExceptions(ctx context.Context, query *EventExceptionQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventException)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(eventexception.FieldEventID)
	}
	query.Where(predicate.EventException(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.ExceptionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPlace != nil {
			_spec.Node.AddColumnOnce(event.FieldPlaceID)
		}
	}
