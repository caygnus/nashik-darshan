...
const (
	// Label holds the string label denoting the placeimage type in the database.
	Label = "place_image"
	...
	EdgePlace = "place"
	// Table holds the table name of the placeimage in the database.
	Table = "place_images"
	// PlaceTable is the table that holds the place relation/edge.
	PlaceTable = "place_images"
...
// Columns holds all SQL columns for placeimage fields.
var Columns = []string{
	FieldID,
	FieldStatus,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the PlaceImage queries.
