...
part of 'dto_occurrence_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DtoOccurrenceResponse extends DtoOccurrenceResponse {
  @override
  ...
  factory _$DtoOccurrenceResponse(
          [void Function(DtoOccurrenceResponseBuilder)? updates]) =>
      (DtoOccurrenceResponseBuilder()..update(updates))._build();

  _$DtoOccurrenceResponse._(
      {this.createdAt,
      this.createdBy,
      this.dayOfMonth,
      this.dayOfWeek,
      ...
      : super._();
  @override
  DtoOccurrenceResponse rebuild(
          void Function(DtoOccurrenceResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DtoOccurrenceResponseBuilder toBuilder() =>
      DtoOccurrenceResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DtoOccurrenceResponse &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DtoOccurrenceResponse')
...
class DtoOccurrenceResponseBuilder
    implements Builder<DtoOccurrenceResponse, DtoOccurrenceResponseBuilder> {
  _$DtoOccurrenceResponse? _$v;
  ...
  DtoOccurrenceResponseBuilder() {
    DtoOccurrenceResponse._defaults(this);
  }

  DtoOccurrenceResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DtoOccurrenceResponse other) {
    _$v = other as _$DtoOccurrenceResponse;
  }

  @override
  void update(void Function(DtoOccurrenceResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DtoOccurrenceResponse build() => _build();

  _$DtoOccurrenceResponse _build() {
    _$DtoOccurrenceResponse _$result;
    try {
      _$result = _$v ??
          _$DtoOccurrenceResponse._(
            createdAt: createdAt,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'DtoOccurrenceResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
