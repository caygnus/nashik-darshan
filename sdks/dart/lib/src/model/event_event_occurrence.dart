...
part 'event_event_occurrence.g.dart';
...
/// * [updatedBy] 
@BuiltValue()
abstract class EventEventOccurrence implements Built<EventEventOccurrence, EventEventOccurrenceBuilder> {
  ...
  EventEventOccurrence._();

  factory EventEventOccurrence([void updates(EventEventOccurrenceBuilder b)]) = _$EventEventOccurrence;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EventEventOccurrenceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<EventEventOccurrence> get serializer => _$EventEventOccurrenceSerializer();
}

class _$EventEventOccurrenceSerializer implements PrimitiveSerializer<EventEventOccurrence> {
  @override
  final Iterable<Type> types = const [EventEventOccurrence, _$EventEventOccurrence];

  @override
  final String wireName = r'EventEventOccurrence';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EventEventOccurrence object, {
  ...
  void _deserializeProperties(
    ...
    required EventEventOccurrenceBuilder result,
  ...
  @override
  EventEventOccurrence deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EventEventOccurrenceBuilder();
