...
part of 'dto_create_occurrence_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DtoCreateOccurrenceRequest extends DtoCreateOccurrenceRequest {
  @override
  ...
  factory _$DtoCreateOccurrenceRequest(
          [void Function(DtoCreateOccurrenceRequestBuilder)? updates]) =>
      (DtoCreateOccurrenceRequestBuilder()..update(updates))._build();

  _$DtoCreateOccurrenceRequest._(
      {this.dayOfMonth,
      this.dayOfWeek,
      this.endTime,
      ...
      : super._();
  @override
  DtoCreateOccurrenceRequest rebuild(
          void Function(DtoCreateOccurrenceRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DtoCreateOccurrenceRequestBuilder toBuilder() =>
      DtoCreateOccurrenceRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DtoCreateOccurrenceRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DtoCreateOccurrenceRequest')
...
class DtoCreateOccurrenceRequestBuilder
    implements
        Builder<DtoCreateOccurrenceRequest, DtoCreateOccurrenceRequestBuilder> {
  _$DtoCreateOccurrenceRequest? _$v;
  ...
  DtoCreateOccurrenceRequestBuilder() {
    DtoCreateOccurrenceRequest._defaults(this);
  }

  DtoCreateOccurrenceRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DtoCreateOccurrenceRequest other) {
    _$v = other as _$DtoCreateOccurrenceRequest;
  }

  @override
  void update(void Function(DtoCreateOccurrenceRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DtoCreateOccurrenceRequest build() => _build();

  _$DtoCreateOccurrenceRequest _build() {
    _$DtoCreateOccurrenceRequest _$result;
    try {
      _$result = _$v ??
          _$DtoCreateOccurrenceRequest._(
            ...
            eventId: BuiltValueNullFieldError.checkNotNull(
                eventId, r'DtoCreateOccurrenceRequest', 'eventId'),
            exceptionDates: _exceptionDates?.build(),
            metadata: _metadata?.build(),
            monthOfYear: monthOfYear,
            recurrenceType: BuiltValueNullFieldError.checkNotNull(
                recurrenceType,
                r'DtoCreateOccurrenceRequest',
                'recurrenceType'),
            startTime: startTime,
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'DtoCreateOccurrenceRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
