...
part 'dto_create_hotel_request.g.dart';
...
/// * [website] 
@BuiltValue()
abstract class DtoCreateHotelRequest implements Built<DtoCreateHotelRequest, DtoCreateHotelRequestBuilder> {
  ...
  DtoCreateHotelRequest._();

  factory DtoCreateHotelRequest([void updates(DtoCreateHotelRequestBuilder b)]) = _$DtoCreateHotelRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DtoCreateHotelRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DtoCreateHotelRequest> get serializer => _$DtoCreateHotelRequestSerializer();
}

class _$DtoCreateHotelRequestSerializer implements PrimitiveSerializer<DtoCreateHotelRequest> {
  @override
  final Iterable<Type> types = const [DtoCreateHotelRequest, _$DtoCreateHotelRequest];

  @override
  final String wireName = r'DtoCreateHotelRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DtoCreateHotelRequest object, {
  ...
  void _deserializeProperties(
    ...
    required DtoCreateHotelRequestBuilder result,
  ...
  @override
  DtoCreateHotelRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DtoCreateHotelRequestBuilder();
